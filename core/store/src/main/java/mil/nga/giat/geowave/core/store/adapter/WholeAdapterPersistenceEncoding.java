 ...
 */
public class WholeAdapterPersistenceEncoding extends
		PersistenceEncoding
{
	private final PersistentValue<Object> adapterExtendedData;

	public WholeAdapterPersistenceEncoding(
			final ByteArrayId adapterId,
			final ByteArrayId dataId,
			final PersistentDataset<? extends CommonIndexValue> commonData,
			final PersistentValue<Object> adapterExtendedData ) {
		super(
				adapterId,
				dataId,
				commonData);
	 ...
	 */
	public PersistentValue<Object> getAdapterExtendedData() {
