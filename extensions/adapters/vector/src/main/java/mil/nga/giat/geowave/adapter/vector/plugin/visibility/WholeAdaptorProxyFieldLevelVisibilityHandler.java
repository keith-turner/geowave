 ...
 */
public class WholeAdaptorProxyFieldLevelVisibilityHandler implements
		FieldVisibilityHandler<SimpleFeature, Object>
{

	private final String fieldName;
	private final WholeFeatureDataAdapter adapter;
	 ...
	 */
	public WholeAdaptorProxyFieldLevelVisibilityHandler(
			final String fieldName,
			final WholeFeatureDataAdapter adapter ) {
		super();
